...
const NAV_GROUPS = {
  Admin: [
    { items: ["Home", "Reports", "Projects", "Invoices"] },
    { label: "WORK", collapsible: true, items: ["Task Board", "Task Lists", "Milestones"] },
  ...
  Manager: [
    { items: ["Home", "Dashboard", "Reports", "Projects"] },
    { label: "OVERVIEW", collapsible: true, items: ["Task Board", "Task Lists", "Milestones", "Issues"] },
